...
const FALLBACK_USER_FILES = {
  ...
  HeyImSoul: "lists/RadiantSoul_Tv.json",
  HeyImSoul_Sub: "lists/RadiantSoul_Tv_SubSounds.json",
  ...
  for (const item of list) {
    ...
    if (isMultiSound) {
      ...
      badge.addEventListener("click", (e) => {
        ...
        badge.textContent = clipList.hidden ? `🎲 ${item.sound.length} clips ▾` : `🎲 ${item.sound.length} clips ▴`;
      });
